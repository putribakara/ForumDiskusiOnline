...
<head>
    ...
    <link rel="stylesheet" types="text/css" href="https://bootswatch.com/4/superhero/bootstrap.min.css">
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color:#4e5d6c">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ url('/').'/image/logoforum.png' }}" style="    max-width: 500px;">
                </a>
